...
generated_resume_path = "outputs/resumes/" # (In Development)
...
file_name = "outputs/logs/all_applied_applications_history.csv"
failed_file_name = "outputs/logs/all_failed_applications_history.csv"
